...
interface FormUpdateNewsDataProps {
    handleOpen: () => void
...
const FormUpdateNewsData = ({ handleOpen, newsData, setIsOpen }: FormUpdateNewsDataProps) => {
    ...
    return (
        <div className="modal-box bg-white">
            <h1 className="text-lg text-neutral-500 mb-5">{`Update news data`}</h1>
...
export default FormUpdateNewsData